...
Can you figure out how this program works to get the flag? Connect to the program with netcat: `$ nc saturn.picoctf.net 50024` The program's source code can be downloaded [here](https://artifacts.picoctf.net/c/524/picker-III.py).

## Datos de Acceso al Nivel

[here](https://artifacts.picoctf.net/c/524/picker-III.py).
## Solucion

```
┌──(kali㉿kali)-[~/picoCTF/reverse/picker2]
└─$ nc saturn.picoctf.net 50024
==> ?
...
<function win at 0x76dc5d494dc0>
==> 4
